...
class HomeViewModel : ViewModel() {
    ...
    private fun getBanksListData() {
        viewModelScope.launch {
            banks.value = banksData.values.toList()
        }
    }

    fun getBankDetails(ifscCode: String) {
        viewModelScope.launch {
            bankDetails.value = banksData[ifscCode]
        }
    }
}